                    ...
                    ?>
                      <tr>
                        ...
                        <td>
                          ...
                          <a onclick="return confirm('apakah anda yakin ingin menghapus data gaji ini?')" href="<?= base_url('admin/penggajian_hapus/' . $data->id_gaji )?>" class="btn btn-danger btn-sm"><span class="fa fa-trash"></span></a>
                        </td>
                      </tr>
                    <?php } ?>
                  </tbody>
