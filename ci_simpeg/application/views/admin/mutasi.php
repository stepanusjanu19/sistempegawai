                ...
                <div class="card">
                    ...
                    <form method="post" action="<?= base_url('admin/mutasi_simpan/') ?>" enctype="multipart/form-data">
                        <div class="card-body">
                            ...
                            <div class="form-group">
                                <label id="lbljabatan" disabled>Jabatan Lama</label>
                                <select name="jabatanlama" id="jabatanlama" oninvalid="InvalidJenisJabatan(this);" oninput="InvalidJenisJabatan(this);" class="form-control" required="required" disabled>
                            ...
                            <div class="form-group">
                                <label id="lbljabatan" disabled>Jabatan Baru</label>
                                <select name="jabatanbaru" id="jabatanbaru" oninvalid="InvalidJenisJabatan(this);" oninput="InvalidJenisJabatan(this);" class="form-control" required="required" disabled>
                                    <option value="">Pilih Jabatan..</option>
                                    <?php foreach ($jabatan as $key) { ?>
                                        <option value="<?= $key->id_jabatan ?>"><?= $key->nama_jabatan ?></option>
                                    <?php } ?>
                            ...
                            <div class="form-group">
                                <label id="lbldepartemen" disabled>Departemen Lama</label>
                                <select name="departemenlama" id="departemenlama" oninvalid="InvalidJenisDepartemen(this);" oninput="InvalidJenisDepartemen(this);" class="form-control" required="required" disabled>
                            ...
                            <div class="form-group">
                                <label id="lbldepartemen" disabled>Departemen Baru</label>
                                <select name="departemenbaru" id="departemenbaru" oninvalid="InvalidJenisDepartemen(this);" oninput="InvalidJenisDepartemen(this);" class="form-control" required="required" disabled>
                                    <option value="">Pilih Departemen..</option>
                                    <?php foreach ($departemen as $key) { ?>
                                        <option value="<?= $key->departemen_id ?>"><?= $key->departemen ?></option>
                                    <?php } ?>
...
<script>
    ...
    function ubahjenis() {
        ...
        document.getElementById("jabatanlama").selectedIndex = 0;
        document.getElementById("departemenlama").selectedIndex = 0;
        document.getElementById("jabatanbaru").disabled = true;
        document.getElementById("departemenbaru").disabled = true;
        checkMutasiDepartemen();
        if (x == 'promosi') {
            document.getElementById("jabatanlama").disabled = true;
            document.getElementById("jabatanbaru").disabled = false;
            document.getElementById("departemenlama").disabled = true;
            document.getElementById("departemenbaru").disabled = true;
            ...
            document.getElementById("jabatanbaru").disabled = true;
            document.getElementById("departemenlama").disabled = true;
            document.getElementById("departemenbaru").disabled = false;
            ...
            xhttps.onreadystatechange = function() {
                if (this.readyState == 4 && this.status == 200) {
                  // alert(this.responseText);
                    ...
                    document.getElementById("jabatanlama").selectedIndex = index;
                    ...
                    document.getElementById("departemenlama").selectedIndex = index;
                }
                // alert("nana");
                // }
